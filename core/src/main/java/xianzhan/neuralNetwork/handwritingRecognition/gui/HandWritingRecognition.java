package xianzhan.neuralNetwork.handwritingRecognition.gui;

import xianzhan.neuralNetwork.handwritingRecognition.data.GoodOutputs;
import xianzhan.neuralNetwork.handwritingRecognition.data.GoodPixels;
import xianzhan.neuralNetwork.handwritingRecognition.data.ReadWriteFile;
import xianzhan.neuralNetwork.handwritingRecognition.gui.components.CustomPanel;
import xianzhan.neuralNetwork.handwritingRecognition.gui.components.DrawingPanel;
import xianzhan.neuralNetwork.handwritingRecognition.neural.Train;
 ...
 * @sinese 2018-04-22
 */
public class HandWritingRecognition extends JFrame {
    ...
    private void setOnClicks() {
        ...
        helpButton.addActionListener(e -> {
            String sb = "Train network X times after you start the program. Recommended 5000 times\n" +
                    "\n" +
                    "Use left/right mouse button to draw/erase\n" +
                    "\n" +
                    "Click \">>\" to see result\n" +
                    "\n" +
                    "Click \"Train\" to train specific letter\n";
            JOptionPane.showMessageDialog(this, sb, "Help", JOptionPane.PLAIN_MESSAGE);
        });
