...
import com.github.xianzhan.analysis.node.ArrayNode;
import com.github.xianzhan.analysis.node.ContainerNode;
import com.github.xianzhan.analysis.node.ElementNode;
import com.github.xianzhan.analysis.node.ElementNode.ElementType;
import com.github.xianzhan.analysis.node.ExpressionNode;
import com.github.xianzhan.intermediate.CodeChunk.Command;
import com.github.xianzhan.intermediate.CodeChunk.ImmediateNumber;
import com.github.xianzhan.intermediate.CodeChunk.ImmediateType;
...
public class ExpressionGenerator {
    ...
    private void createConditionExpression(int var, ExpressionNode expression, ChunkContext context) throws IntermediateCodeExpression {
        ...
        context.codeChunk.push(CodeChunk.Command.JumpWhen, leftExpressionHolder, var);
    ...
    private void createElement(int var, ElementNode element, ChunkContext context) throws IntermediateCodeExpression {
        if (element.type == ElementType.Variable) {
            ...
            for (Map.Entry<String, ExpressionNode> e : container.content.entrySet()) {
                String key = e.getKey();
