package com.github.xianzhan.tao.analysis;

import com.github.xianzhan.tao.analysis.Token.Type;
import com.github.xianzhan.tao.analysis.exception.SyntacticAnalysisException;
import com.github.xianzhan.tao.analysis.node.*;
import com.github.xianzhan.tao.analysis.symbol.NonTerminalSymbol.Exp;
...
public class AnalysisDefine {
                ...
                public void match(AnalysisNode analysisNode) throws SyntacticAnalysisException {
                    if (analysisNode instanceof ExpressionNode) {
                        ...
                        if (target instanceof ElementNode) {
                            ...
                            if (element.type == ElementNode.ElementType.Variable && !element.fromThis && !element.fromConstructor) {
    ...
    public static AnalysisNode createContainer(Exp exp) {
    ...
    private static ElementNode createVariableElement(String varName) {
        ...
        element.type = ElementNode.ElementType.Variable;
