...
import xianzhan.pascal.ide.impl.CallStackFrame;
import xianzhan.pascal.ide.impl.ConsoleFrame;
import xianzhan.pascal.ide.impl.DebugFrame;
import xianzhan.pascal.ide.impl.EditFrame;
 ...
 * @since 2019-07-10
 */
public class IDEFrame extends JFrame implements IDEControl {
    ...
    private static final int CONSOLE_WIDTH  = EDITOR_WIDTH + WINDOW_SPACING + STACK_WIDTH;
    private static final int CONSOLE_HEIGHT = 350;

    private static final int DEBUGGER_WIDTH  = 600;
    private static final int DEBUGGER_HEIGHT = EDITOR_HEIGHT + WINDOW_SPACING + CONSOLE_HEIGHT;

    private static final int IDE_WIDTH  = EDITOR_WIDTH + WINDOW_SPACING + STACK_WIDTH + WINDOW_SPACING + DEBUGGER_WIDTH + 2 * BORDER_SIZE;
    private static final int IDE_HEIGHT = HEADER_HEIGHT + DEBUGGER_HEIGHT + 2 * BORDER_SIZE;
