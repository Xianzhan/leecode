 ...
 * @since 2019-07-11
 */
public class DebugFrame extends JInternalFrame implements ActionListener {
    ...
    /**
     * listing lines buffer
     */
    private Vector lineBuffer = new Vector();
    ...
    private class ListingLineRenderer extends JLabel implements ListCellRenderer {
        ...
        public Component getListCellRendererComponent(JList list,
            ...
            ImageIcon icon = !line.isBreakable()
                    ? nobreakIcon : !programRunning
                    ? nobreakIcon : line.isBreakpoint()
                    ? breakPointIcon : breakableIcon;
