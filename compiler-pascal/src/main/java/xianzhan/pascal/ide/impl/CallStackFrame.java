...
/**
 * The call stack window of the Pascal IDE.
 *
 * @author xianzhan
 * @since 2019-07-11
 */
public class CallStackFrame extends JInternalFrame implements ActionListener, TreeSelectionListener {
     ...
     */
    void initGuiComponents() throws Exception {
        ...
        callTree.setFont(new Font("Courier", Font.PLAIN, 12));
    ...
    public void addVariable(String name, String value) {
        ...
        treeModel.insertNodeInto(variableNode, currentRoutineNode, variableNodeIndex++);
    }
    ...
    public void valueChanged(TreeSelectionEvent event) {
        ...
        DefaultMutableTreeNode node = (DefaultMutableTreeNode) path.getPath()[path.getPathCount() - 1];
