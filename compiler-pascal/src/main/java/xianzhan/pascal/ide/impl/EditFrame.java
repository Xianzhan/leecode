...
/**
 * The edit window of the Pascal IDE.
 *
 * @author xianzhan
 * @since 2019-07-10
 */
public class EditFrame extends JInternalFrame implements ActionListener, CaretListener {
    ...
    private void initGuiComponents() throws Exception {
        ...
        sourceArea.setFont(new Font("Courier", Font.PLAIN, 12));
    ...
    private void browseSourceAction() {
        IDEFileChooser chooser = new IDEFileChooser(
                System.getProperty("user.dir"),
                null,
                new IdeFileFilter(new String[]{".pas"}, "Pascal files (*.pas)")
        );
    ...
    private void saveSourceAction() {
        ...
        try (BufferedWriter sourceFile = new BufferedWriter(new FileWriter(control.getSourcePath(), false))) {
    ...
    private void browseInputAction() {
        IDEFileChooser chooser = new IDEFileChooser(
                System.getProperty("user.dir"),
                null,
                new IdeFileFilter(new String[]{".in", "*.txt", "*.dat"}, "Input files (*.in, *.txt, *.dat)")
        );
